...
var ProductListModel = {
	...
	_getFilter : function(req){
		...
		if(categoriesText !== undefined && categoriesText != "[]"){
			filter.categories = {$in: JSON.parse(categoriesText)};
		}
		return filter;
	},
	...
	_getCategorieObject : function(model, category, products){
		...
		if(model.req !== undefined && model.req.body !== undefined && model.req.body.categories !== undefined 
			&& model.req.body.categories.indexOf(category.shortName) > -1){
